  ...
  return (
    <div className="max-w-primary-col mx-auto">
      ...
      <div className="w-full grid grid-cols-2">
        ...
        <div className="grow p-6 flex flex-col items-center justify-center">
          <div className="w-full">
            <div className="uppercase text-primary font-extrabold mb-2">Flow meter Data</div>
      ...
      <div className="w-full grid grid-cols-2">
        <div className="grow p-6 flex flex-col items-center justify-center">
          <div className="w-full">
            <div className="uppercase text-primary font-extrabold mb-2">Export to PDF</div>
